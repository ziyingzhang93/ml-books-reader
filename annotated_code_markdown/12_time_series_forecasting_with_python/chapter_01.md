...
This script demonstrates **check the versions of key python libraries**.

本脚本演示 **check the versions of key python libraries**。
...
---
## Step 1 — check the versions of key python libraries
scipy
...
- **概念**: check the versions of key python libraries 是机器学习中的常用技术。  
  *check the versions of key python libraries is a common technique in machine learning.*
