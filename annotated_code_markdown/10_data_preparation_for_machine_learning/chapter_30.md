...
### Model With Svd Transform

# 02 — Model With Svd Transform / 数据变换
...
This script demonstrates **evaluate svd with logistic regression algorithm for classification**.

本脚本演示 **evaluate svd with logistic regression algorithm for classification**。
...
---
## Step 1 — evaluate svd with logistic regression algorithm for classification
...
- **概念**: evaluate svd with logistic regression algorithm for classification 是机器学习中的常用技术。  
  *evaluate svd with logistic regression algorithm for classification is a common technique in machine learning.*
...
This script demonstrates **compare svd number of components with logistic regression algorithm for classification**.

本脚本演示 **compare svd number of components with logistic regression algorithm for classification**。
...
---
## Step 1 — compare svd number of components with logistic regression algorithm for classification
...
- **概念**: compare svd number of components with logistic regression algorithm for classification 是机器学习中的常用技术。  
  *compare svd number of components with logistic regression algorithm for classification is a common technique in machine learning.*
...
This script demonstrates **make predictions using svd with logistic regression**.

本脚本演示 **make predictions using svd with logistic regression**。
...
---
## Step 1 — make predictions using svd with logistic regression
...
- **概念**: make predictions using svd with logistic regression 是机器学习中的常用技术。  
  *make predictions using svd with logistic regression is a common technique in machine learning.*
...
## Evolution / 演化路线
  ...
  2. `02_model_with_svd_transform.ipynb` — Model With Svd Transform
